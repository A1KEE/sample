    ...
    <div class="card-body">
      ...
      <form action="action.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-5">
          ...
          <input type="text" name="Lesson_chapter" required class="form-control" placeholder="Enter Lesson Chapter">
        </div>

        <div class="form-group">
        <div class="col-md-5">
          <label for="">Lesson Title</label>
          <input type="text" name="Lesson_title" required class="form-control" placeholder="Enter Lesson Title">
        </div>

        <div class="form-group">
         <div class="col-md-5">
          <label for="">Select File Type</label>
          <select class="form-control" name="Lesson_category" placeholder="Enter Lesson Chapter">
               <option>Docs</option>
               <option>Video</option>
          </select>
        </div>
        ...
        <div class="form-group">
           <div class="col-md-5">
             ...
             <input type="text" name="Lesson_Subject"  required class="form-control" placeholder="Enter Subject">
        </div>
                            
        <div class="form-group">
         <div class="col-md-5">
          <label for="">Lesson Image</label>        
          <input type="file" name="Lesson_image" required class="form-control"><br>
        </div>
        <div class="form-group">
        <div class="col-md-5">
          <button type= "submit" name="save_lesson" required class="btn btn-primary">SUBMIT</button>
        </div>
      </form>
    </div>
