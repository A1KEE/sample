        ...
        <div class="row">
            ...
            <div class="info-box">
             ...
             ?>
              <div class="info-box-content">
                <span class="info-box-text">Number of Year&Section</span>
          ...
          <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
               <span class="info-box-text">Number of Lesson</span>
               <?php
              $connectiondb = mysqli_connect("localhost","root","","dtr_system");

              $query = "SELECT LessonID FROM tbl_lesson ORDER BY LessonID";
